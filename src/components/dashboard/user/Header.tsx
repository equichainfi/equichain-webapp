            ...
            <header className="w-full">
                <section className="flex flex-col">
                    <Image
                        ...
                        height={100}
                        className={clsx(
                            "w-screen min-h-[120px] max-h-[160px] md:max-h-[200px] lg:max-h-[225px] xl:max-h-[325px] object-center object-cover",
                            pathname === "/account"
                                ? " cursor-pointer hover:opacity-80 transition-all duration-300 ease-in-out"
                                : "",
                        )}
                        onClick={(): void => {
                            if (pathname === "/account") {
                    ...
                    <div className="ml-2 my-5 flex sm:ml-10 lg:ml-16 xl:ml-20 2xl:ml-24 items-start justify-start absolute top-24 md:top-36 lg:top-44 xl:top-58 2xl:top-64 3xl:top-72 bg-white rounded-full">
                        <Image
                            ...
                            height={100}
                            className={clsx(
                                "rounded-full border-4 border-gray-300 h-28 sm:h-36 lg:h-36 2xl:h-40 w-28 sm:w-36 lg:w-36 2xl:w-40 relative z-10 object-center object-cover",
                                pathname === "/account"
                                    ? " cursor-pointer hover:opacity-80 transition-all duration-300 ease-in-out"
                                    : "",
                            )}
